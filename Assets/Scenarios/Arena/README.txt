...
If you are using Unity and want to get up an running right away you can open the "Arena.unitypackage" which also comes with an Example Scene.

If not look under the "Models" folder.

The "Models" folder contains the model in both .fbx and .blend format along with all of the textures. Unless you have Blender installed we recommend importing the .fbx.
